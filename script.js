...
let food = { //criar posição aleatória da comida
...
function criarCobrinha () { //criar tamanho da cobrinha e cor para cada parte dela
...
function drawFood () { //desenhar comida com sua posição aleatória
